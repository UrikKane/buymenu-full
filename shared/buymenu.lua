...
function BuyMenuEntry:__init( model_id, price, entry_type )
    ...
    self.price = price
	-- ^ change self.price = price to self.price = 0 if you want everything to be free
...
function BuyMenu:CreateItems()
    ...
    self.items = {
        ...
        [self.types.Weapon] = {
            { "One-handed", "Two-handed" , "One-handed DLC", "Two-handed DLC" },
            ["One-handed"] = {
            ...
            ["One-handed DLC"] = {
				WeaponBuyMenuEntry( Weapon.SignatureGun, 2000, 1, "Rico's Signature Gun" )
            },
            ...
            ["Two-handed DLC"] = {
			WeaponBuyMenuEntry( Weapon.Airzooka, 10000, 2, "Air Propulsion Gun" ),
			WeaponBuyMenuEntry( Weapon.ClusterBombLauncher, 10000, 2, "Cluster Bomb Launcher" ),
			WeaponBuyMenuEntry( Weapon.MultiTargetRocketLauncher, 10000, 2, "Multi-target Rocket Launcher" ),
			WeaponBuyMenuEntry( Weapon.QuadRocketLauncher, 15000, 2, "Quad Rocket Launcher" ),
			WeaponBuyMenuEntry( Weapon.AlphaDLCWeapon, 15000, 2, "Bull's Eye Assault Rifle" )
            }
        },
